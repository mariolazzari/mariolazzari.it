...
export function Kpi({ title, icon, value }: KpisProps) {
  return (
    <div className="group flex flex-col items-center gap-4 p-4 rounded-xl shadow-xl w-48 h-40 bg-linear-to-br from-background to-secondary border-muted hover:border-primary">
